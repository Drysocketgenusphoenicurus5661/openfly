...
class EncoderProtocol(Protocol):
    ...
    def encode(self, observation: MarketObservation, brain: BrainProtocol) -> Stimulus: ...
...
class ReadoutProtocol(Protocol):
    ...
    def predict(self, counts: np.ndarray, brain: BrainProtocol, observation: MarketObservation) -> Prediction: ...
